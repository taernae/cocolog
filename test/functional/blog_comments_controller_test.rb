...
class BlogCommentsControllerTest < ActionController::TestCase
  ...
  test "should create blog_comment" do
    assert_difference('BlogComment.count') do
      post :create, blog_comment: { author: @blog_comment.author, body: @blog_comment.body, creator: @blog_comment.creator, modpost: @blog_comment.modpost, owner: @blog_comment.owner, reply: @blog_comment.reply }
    end
  ...
  test "should update blog_comment" do
    put :update, id: @blog_comment, blog_comment: { author: @blog_comment.author, body: @blog_comment.body, creator: @blog_comment.creator, modpost: @blog_comment.modpost, owner: @blog_comment.owner, reply: @blog_comment.reply }
    assert_redirected_to blog_comment_path(assigns(:blog_comment))
  end
